...
| [Glass effect](#glass-effect) | [Glass (custom)](#glass-effect) | [Wedge (closest to ref)](#reflex-style-band-vs-wedge) | [Wedge (sharper)](#reflex-style-band-vs-wedge) |
...
| `Band` (default) | `Wedge` (closest to ref) | `Wedge` (sharper) | `Wedge` (softer) |
| :---: | :---: | :---: | :---: |
