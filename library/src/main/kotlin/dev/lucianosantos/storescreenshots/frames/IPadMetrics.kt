...
internal object IPadAir13Metrics {
    ...
    /**
     * How deep the enclosure is, front to back. An iPad Air 13 is 6.1 mm across 280.6 mm of width,
     * so 0.0217 of [BodyWidth] — proportionally a quarter of a phone's depth, which is why a tilted
     * tablet shows a much narrower rail than a tilted phone at the same angle.
     */
    const val BodyThickness = BodyWidth * 0.0217f
